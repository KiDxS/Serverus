            ...
            <form action="{{ route('add.product') }}" method="POST">
                ...
                <div class="col" style="padding: 200px">
                    <label class="form-label" style="padding: 20px">Product Name:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        <input class="bg-secondary border rounded shadow form-control-sm" type="text" name="product_name" />
                    </label>
                    <label class="form-label" style="padding: 20px">Product Quantity:&nbsp; &nbsp;
                        <input class="bg-secondary border rounded shadow form-control-sm" type="text" name="quantity" inputmode="numeric" />
                    </label>
                    <label class="form-label" style="padding: 20px">Cost Price:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp;&nbsp;
                        <input class="bg-secondary border rounded shadow form-control-sm" type="text" name="cost_price" inputmode="numeric" />
                    </label>
                    <label class="form-label" style="padding: 20px">Sale Price:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;
                        <input class="bg-secondary border rounded shadow form-control-sm" type="text" name="sale_price" inputmode="numeric" />
                    </label>
                </div>
